...
const { confirmBooking, calculate, successBooking, requestRecived, adminBooking } = require("../controllers/bookingController");
const { saveTestimonial } = require("../controllers/testimonialController");
const { registerAdmin, loginAdmin, loginPage, adminDashboard, logout, search, adminImage, updateBooking, adminBookingPage } = require("../controllers/adminController");
...
router.get("/adminbooking", authenticateAdmin, adminBookingPage);
router.post("/adminBookingRequest", authenticateAdmin, adminBooking);
...
router.get("/requestSent", authenticateAdmin, requestRecived);
